                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <form action="{{ URL::to('save-receive') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                @if($receive->to == NULL)
                                <input type="hidden" name="afterReceive" id="afterReceive" value="{{ $receive->afterReceive }}">
                                @else
                                <input type="hidden" name="afterReceive" id="afterReceive" value="{{ $receive->to  }}">
                                @endif
                                ...
                                <input type="text" class="form-control" name="dms_no" id="dms_no"
                                    value="{{ $receive->DocTrack->dms_no }}" readonly>
                            </div>
                            <div class="mb-3">
